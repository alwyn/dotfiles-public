...
/* appearance */
static const unsigned int borderpx  = 2;        /* border pixel of windows */ /* Alwyn changed to 2 from 1 */
...
static const char col_cyan[]        = "#5757FF";  /* "#6790EB"; */  /* Alwyn */
static const char col_spanyel[]     = "#FDB511";  /* Alwyn spanish yellow */
static const unsigned int baralpha = 0xd0;
static const unsigned int borderalpha = OPAQUE;
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_cyan,  col_spanyel },
};
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_Return, zoom,           {0} },  /* Alwyn, because MOD Enter is used already for terminal */
	/*{ MODKEY,                       XK_Return, zoom,           {0} },*/
	{ MODKEY,                       XK_Tab,    view,           {0} },   /* Alwyn uncommented */
